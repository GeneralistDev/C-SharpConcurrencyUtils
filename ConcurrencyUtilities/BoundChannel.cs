...
namespace ConcurrencyUtils
{
    ...
    public class BoundChannel<T> : Channel<T>
    {
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ConcurrencyUtils.BoundChannel`1"/> class
		...
		/// <summary>
		/// Put the specified item into the Channel if there is space, will wait on Acquire() if there isn't.
		/// </summary>
